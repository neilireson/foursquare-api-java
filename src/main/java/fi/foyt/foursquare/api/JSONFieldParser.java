            ...
            for (String objectFieldName : objectFieldNames) {
                ...
                if (fieldClass == null) {
                    ...
                    if (setterMethod == null) {
                        ...
                        if (parameters.length == 1) {
                            ...
                            try {
                                ...
                                throw new FoursquareApiException("Could not set field " + objectFieldName + " from " + entity.getClass().getName() + " class");
                            }
                        } else {
                            throw new FoursquareApiException("Could not find field " + objectFieldName + " from " + entity.getClass().getName() + " class");
                        }
                    ...
                    try {
                        ...
                        throw new FoursquareApiException("Failed to parse field: " + objectFieldName + ": " + e.getLocalizedMessage() + "\n" + jsonObject, e);
                    }
                }
            }
        }
