...
public class Tips {
  ...
  public final void testTip() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1264477738), result.getResult().getCreatedAt());
    ...
    assertEquals(Long.valueOf(0), result.getResult().getTodo().getCount());
    assertEquals(Long.valueOf(7), result.getResult().getDone().getCount());
  ...
  public final void testTipsAdd() throws FoursquareApiException {
    ...
    assertEquals(Integer.valueOf(200), result.getMeta().getCode());
    assertEquals(Long.valueOf(1307700304), result.getResult().getCreatedAt());
    assertEquals(text, result.getResult().getText());
    assertEquals(url, result.getResult().getUrl());
    assertEquals(Long.valueOf(0), result.getResult().getTodo().getCount());
    assertEquals(Long.valueOf(1), result.getResult().getDone().getCount());
  ...
  public final void testTipsMarkTodo() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1307706288), result.getResult().getCreatedAt());
  ...
  public final void testTipsSearch() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1293118080), result.getResult()[0].getCreatedAt());
  ...
  public final void testTipsMarkDone() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1293132269), result.getResult().getCreatedAt());
    assertEquals("", result.getResult().getText());
    assertEquals("done", result.getResult().getStatus());
    assertEquals(Long.valueOf(7), result.getResult().getTodo().getCount());
    assertEquals(Long.valueOf(3), result.getResult().getDone().getCount());
