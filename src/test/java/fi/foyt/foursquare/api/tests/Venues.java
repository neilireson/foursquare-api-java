...
public class Venues {
  ...
  public final void testVenue() throws FoursquareApiException {
    ...
    assertEquals(Double.valueOf(40.721294), result.getResult().getLocation().getLat());
    assertEquals(Double.valueOf(-73.983994), result.getResult().getLocation().getLng());
    ...
    assertEquals(Integer.valueOf(14765), result.getResult().getStats().getCheckinsCount());
    assertEquals(Integer.valueOf(10752), result.getResult().getStats().getUsersCount());
    assertEquals("http://www.clintonstreetbaking.com", result.getResult().getUrl());
    assertEquals(Long.valueOf(5), result.getResult().getHereNow().getCount());
    assertEquals("475129", result.getResult().getMayor().getUser().getId());
    assertEquals(Long.valueOf(372), result.getResult().getTips().getCount());
    assertEquals(Long.valueOf(372), result.getResult().getTips().getGroups()[0].getCount());
    ...
    assertNull(result.getResult().getSpecialsNearby());
    assertEquals("http://4sq.com/1UrXyu", result.getResult().getShortUrl());
    assertEquals("America/New_York", result.getResult().getTimeZone());
    assertNull(result.getResult().getBeenHere());
    assertEquals(Long.valueOf(996), result.getResult().getPhotos().getCount());
    assertNull(result.getResult().getDescription());
  }
...
//    assertEquals("standard", result.getResult().getSpecials().getItems()[0].getRedemption());
  ...
  public final void testVenuesAdd() throws FoursquareApiException {
    ...
    assertEquals(Double.valueOf(0.0), completeVenue.getResult().getLocation().getDistance());
    ...
    assertEquals(Long.valueOf(0), completeVenue.getResult().getPhotos().getGroups()[0].getCount());
  }
...
//    assertEquals("https://foursquare.com/img/categories/arts_entertainment/default.png", result.getResult()[0].getIcon().getPrefix());
  ...
  public final void testVenuesSearch() throws FoursquareApiException {
    ...
    assertEquals(Double.valueOf(40.70443641202592), trendingGroup.getItems()[0].getLocation().getLat());
    assertEquals(Double.valueOf(-74.01012361049652), trendingGroup.getItems()[0].getLocation().getLng());
    ...
    assertEquals(Integer.valueOf(5656), trendingGroup.getItems()[0].getStats().getCheckinsCount());
    assertEquals(Integer.valueOf(3453), trendingGroup.getItems()[0].getStats().getUsersCount());
    // assertEquals(Long.valueOf(0), trendingGroup.getItems()[0].getTodos().getCount());
    assertEquals(Long.valueOf(15), trendingGroup.getItems()[0].getHereNow().getCount());
    ...
    assertEquals(Double.valueOf(40.701984159668676), nearbyGroup.getItems()[0].getLocation().getLat());
    assertEquals(Double.valueOf(-73.9969539642334), nearbyGroup.getItems()[0].getLocation().getLng());
    ...
    assertEquals(Integer.valueOf(4232), nearbyGroup.getItems()[0].getStats().getCheckinsCount());
    assertEquals(Integer.valueOf(2707), nearbyGroup.getItems()[0].getStats().getUsersCount());
    // assertEquals(Long.valueOf(0), nearbyGroup.getItems()[0].getTodos().getCount());
    assertEquals(Long.valueOf(0), nearbyGroup.getItems()[0].getHereNow().getCount());
  }
  ...
  public final void testVenuesSearch20110615() throws FoursquareApiException {
    ...
    assertEquals(Double.valueOf(40.701984159668676), venue.getLocation().getLat());
    assertEquals(Double.valueOf(-73.9969539642334), venue.getLocation().getLng());
    assertEquals("4bf58dd8d48988d163941735", venue.getCategories()[0].getId());
    assertEquals(false, venue.getVerified());
    assertEquals(Integer.valueOf(4532), venue.getStats().getCheckinsCount());
    assertEquals(Integer.valueOf(2997), venue.getStats().getUsersCount());
    assertEquals(Long.valueOf(3), venue.getHereNow().getCount());
  }
  ...
  public final void testVenuesTrending() throws FoursquareApiException {
    ...
    assertEquals(Double.valueOf(40.70443641202592), result.getResult()[0].getLocation().getLat());
    assertEquals(Double.valueOf(-74.01012361049652), result.getResult()[0].getLocation().getLng());
    ...
    assertEquals(Integer.valueOf(5656), result.getResult()[0].getStats().getCheckinsCount());
    assertEquals(Integer.valueOf(3453), result.getResult()[0].getStats().getUsersCount());
    // assertEquals(Long.valueOf(0), result.getResult()[0].getTodos().getCount());
    assertEquals(Long.valueOf(12), result.getResult()[0].getHereNow().getCount());
  }
  ...
  public final void testVenuesExplore() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(30), result.getResult().getKeywords().getCount());
    ...
    assertEquals(Long.valueOf(1), result.getResult().getGroups()[0].getItems()[0].getReasons().getCount());
  ...
  public final void testVenuesHereNow() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1307623515), result.getResult().getItems()[0].getCreatedAt());
  ...
  public final void testVenuesLinks() throws FoursquareApiException {
    ...
    assertEquals(Integer.valueOf(200), result.getMeta().getCode());
    assertEquals(Long.valueOf(5), result.getResult().getCount());
  ...
  public final void testVenuesTips() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(103), result.getResult().getCount());
    assertEquals("4def98fefa76c1ceac95dec0", result.getResult().getItems()[0].getId());
    assertEquals(Long.valueOf(1307547902), result.getResult().getItems()[0].getCreatedAt());
  ...
  public final void testVenuesMarkTodo() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1307854977), result.getResult().getCreatedAt());
    assertEquals("4d13a1edf898b1f73ac3e181", result.getResult().getTip().getId());
    assertEquals(Long.valueOf(1293132269), result.getResult().getTip().getCreatedAt());
    assertEquals("", result.getResult().getTip().getText());
    assertEquals("todo", result.getResult().getTip().getStatus());
    assertEquals(Long.valueOf(6), result.getResult().getTip().getTodo().getCount());
    assertEquals(Long.valueOf(3), result.getResult().getTip().getDone().getCount());
  ...
  public final void testVenuesPhotos() throws FoursquareApiException {
    ...
    assertEquals(Integer.valueOf(200), result.getMeta().getCode());
    assertEquals(Long.valueOf(28), result.getResult().getCount());
    assertEquals("4ddf19dea12d19527932b4eb", result.getResult().getItems()[0].getId());
    assertEquals(Long.valueOf(1306466782), result.getResult().getItems()[0].getCreatedAt());
    ...
    assertEquals(Long.valueOf(4), result.getResult().getItems()[0].getSizes().getCount());
    assertEquals(Integer.valueOf(720), result.getResult().getItems()[0].getSizes().getItems()[0].getHeight());
    assertEquals(Integer.valueOf(537), result.getResult().getItems()[0].getSizes().getItems()[0].getWidth());
