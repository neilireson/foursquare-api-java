...
public class Photos {
  ...
  public final void testPhoto() throws FoursquareApiException {
    ...
    assertEquals(Long.valueOf(1292875798), result.getResult().getCreatedAt());
    ...
    assertEquals(Long.valueOf(4), result.getResult().getSizes().getCount());
    ...
    assertEquals(Integer.valueOf(540), result.getResult().getSizes().getItems()[0].getWidth());
    assertEquals(Integer.valueOf(720), result.getResult().getSizes().getItems()[0].getHeight());
  ...
  public final void testPhotosAdd() throws FoursquareApiException, IOException {
    ...
    assertEquals(Integer.valueOf(200), result.getMeta().getCode());
    assertEquals("4df3a350fd286d19d4beb926", result.getResult().getId());
    assertEquals(Long.valueOf(1307812688), result.getResult().getCreatedAt());
    ...
    assertEquals(Integer.valueOf(450), result.getResult().getSizes().getItems()[0].getWidth());
    assertEquals(Integer.valueOf(664), result.getResult().getSizes().getItems()[0].getHeight());
